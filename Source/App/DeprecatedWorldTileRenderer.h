...
{
public:
	DeprecatedWorldTileRenderer(SDL_Renderer* renderer, AssetManager* assets);
	~DeprecatedWorldTileRenderer();
...
private:
	DeprecatedWorldTileRenderer(const DeprecatedWorldTileRenderer&);
	DeprecatedWorldTileRenderer& operator=(const DeprecatedWorldTileRenderer&);
