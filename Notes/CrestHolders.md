# Fivefold Circuit Crest Holders
...
Aurelia is Emberglen's festival adjudicator and the first sanctioned master most new Circuit entrants face. Her reputation is not built on spectacular finishes. It comes from identifying the exact mistake that caused an opponent's plan to collapse.

She is formal, observant, and quietly encouraging. Aurelia never mocks an inexperienced challenger, but she also refuses to award a Crest for enthusiasm alone. Her official robes are ivory and gold, with the Dawn Crest worn as a sun-shaped clasp at her shoulder.

### Arena trial

The Festival Trial was supposed to be the player's first official match before the Fading interrupted it. After defeating the Veiled One, the player must demonstrate that Emberglen is stable by defeating three different local duelists and speaking with the townspeople whose cards were restored.

The trial measures responsibility rather than raw strength. It also allows the current Act I progression to lead naturally into the Circuit story.

### Deck profile

Aurelia uses a disciplined Light deck built around blockers, shield manipulation, tapping opposing creatures, and a small number of powerful finishers. Hanusa is the card most closely linked to her, while the official Crest match introduces Urth as a late-game threat.

Her AI should value keeping at least one blocker available, avoid wasting tap effects on poor attacks, and recognize when a defensive board has become strong enough to end the duel.

### Hollow-story role

Aurelia saw Rowan pursue the blank cards toward the bridge and becomes one of the player's first witnesses. Awarding the Dawn Crest after the crisis is her declaration that the Curator does not get to decide when ordinary life stops.
...
Brassa is Cinderrail's chief railwright and the undefeated captain of its workers' duel club. She has a powerful build, a shaved head, a copper welding visor, and a heavy red coat patched with pale Light-civilization cloth. The Forge Crest is stamped into a metal gauntlet rather than displayed as jewelry.

She is direct, practical, and impatient with dramatic speeches. Every challenge is treated like a machine inspection: establish what failed, repair it, and run the test again. Away from the arena, she quietly pays entry fees for apprentices who cannot afford Circuit registration.

### Arena trial

Three resonance furnaces power the Cinderrail arena. The player must defeat the duelists stationed at each furnace and decide the safe order in which to bring them online. Activating everything immediately overloads the system and creates an optional extra encounter.

The lesson is the same as Brassa's deck: committing resources quickly is valuable only when the supporting structure is ready.

### Deck profile

Brassa combines fast Fire Humans with Light blockers and tap effects. Small attackers pressure shields while the Light cards protect valuable evolution material. Armored Blaster Valdios turns an apparently modest board into a decisive attack, and Scarlet Skyterror punishes an opponent who relies too heavily on blockers.

Her AI should distinguish expendable attackers from evolution material, preserve the creatures needed for Valdios, and tap or remove blockers before committing its strongest creature.

### Hollow-story role

The Curator's collectors secretly modified Cinderrail's furnaces to harvest resonance from public matches. Brassa initially refuses to close the arena because the rail network depends on its power. Flint helps prove that the machinery can be separated, giving Brassa a personal reason to oppose the Curator.

### Reward and rematches

- **First victory:** Forge Crest and Armored Blaster Valdios
...
Oren was chosen as Crest Holder by the communities surrounding Rootmaze, but they refuse ceremonial titles and hold official matches in a clearing open to both people and creatures. Their cloak is woven from living leaves over practical blue traveling clothes, and the Verdant Crest hangs from a carved wooden staff.

They are warm, distractible, and exceptionally perceptive about creatures. Oren often pauses a conversation to respond to something nobody else heard. Their apparent lack of organization conceals a precise understanding of how dozens of living systems affect one another.

### Arena trial

The paths through Rootmaze change whenever a damaged creature echo becomes frightened. The player restores three routes by finding the bonded duelists and resolving their disagreements through matches. The shortest solution is not always the kindest, and helping every displaced creature unlocks Oren's stronger optional rematch.

### Deck profile

Oren combines Nature mana acceleration and Beast Folk evolutions with Water draw, bounce, and Liquid People evolutions. Fighter Dual Fang rewards early board development, while Crystal Lancer can finish games that stall.

The deck is deliberately capable of two different winning plans. Oren's AI should choose between continued mana growth, a Beast Folk evolution, or a Water tempo turn based on the actual board rather than always playing the most expensive card.

### Hollow-story role

Rootmaze proves that an echo can briefly survive outside its physical card. Briar and Oren use this discovery to return displaced creatures, while the Curator sees it as evidence that echoes can be transferred into the Hollow Deck.
...
Sable is a former championship finalist who withdrew after realizing that the Circuit's analysts could predict nearly every deck they registered. They founded Mirror Arena to train duelists whose strategies could survive being understood.

Their clothing is split into dark and pale halves beneath a reflective blue mantle. They speak with playful ambiguity during public appearances but become precise and candid when teaching. Sable dislikes the reputation that they “use your own deck against you”; their actual talent is identifying what a deck cannot comfortably do.

### Arena trial

The player faces three duelists representing aggression, defense, and resource control. They may change their active deck between matches. Sable's registered deck variant is selected from several legal lists according to the player's dominant civilizations and strategy.
...
- **First victory:** Mirror Crest and Miraculous Plague
...
Caelum guards the final arena before the Grand Championship. He was once known for building brilliant but inconsistent five-civilization decks. After losing a championship match with an unusable hand, he spent years studying the Survivors—creatures whose abilities become stronger through cooperation.

He is relaxed, humorous, and completely unshaken by impressive cards. His white traveling coat carries five narrow civilization-colored bands that join at the Unity Crest over his heart. He treats nervous challengers to tea before the match and then plays without mercy.
...
Caelum uses a legal five-civilization Survivor deck. Individual cards appear modest, but each Survivor expands the value of the entire board. Mana fixing, shield triggers, and carefully distributed civilization sources keep the deck consistent.

Q-tronic Omnistrain embodies his philosophy and is the primary signature card. Bombazar may appear only in the hardest rematch, where the deck is explicitly tuned around its risk rather than treating it as generic power.

His AI should prioritize civilization access in mana, preserve complementary Survivors, and value the board-wide effect of each summon. It must remain constrained by normal information and rules.
