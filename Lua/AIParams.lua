...
AIParams = {
	...
	personalities = {
		rush = {
			...
			evaluation = {
				shield_count_1_value = 7.0,
				shield_count_2_value = 14.0,
				shield_count_3_value = 21.0,
				shield_count_4_value = 28.0,
				shield_count_5_value = 34.0,
				shield_above_5_value = 6.0,
				knockout_bonus = 12.0,
				mana_card_value = 2.5,
				hand_base_value = 2.0,
				hand_cost_bonus = 0.05,
				creature_breaker_value = 3.5,
			},
		},
		tempo = {
			evaluation = {
