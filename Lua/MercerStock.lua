return {
	...
	shards = {
		...
		{
			id = "chimera", name = "Chimera Shard", position = { x = 10, y = 1 },
			stock = { "Gigagiele", "Gigaberos", "Gigastand", "Terror Pit" }
		},
		{
			id = "parasite_worm", name = "Parasite Worm Shard", position = { x = 15, y = 1 },
			stock = { "Stinger Worm", "Poison Worm", "Horrid Worm", "Death Smoke" }
		},
		{
			id = "human", name = "Human Shard", position = { x = 1, y = 3 },
			stock = { "Immortal Baron, Vorg", "Mini Titan Gett", "Fatal Attacker Horvath" }
		},
		{
			id = "armoroid", name = "Armoroid Shard", position = { x = 6, y = 3 },
		...
		{
			id = "dragonoid", name = "Dragonoid Shard", position = { x = 3, y = 4 },
			stock = { "Onslaughter Triceps", "Deadly Fighter Braid Claw",
				"Fire Sweeper Burning Hellion", "Explosive Fighter Ucarn", "Burning Power" }
		},
		{
			id = "fire", name = "Fire Shard", position = { x = 13, y = 4 }, stock = {}
		},
		{
			id = "giant_insect", name = "Giant Insect Shard", position = { x = 5, y = 6 },
			stock = { "Red-Eye Scorpion" }
		},
		{
			id = "colony_beetle", name = "Colony Beetle Shard", position = { x = 9, y = 6 },
			stock = { "Tower Shell" }
		},
		{
			id = "horned_beast", name = "Horned Beast Shard", position = { x = 17, y = 6 },
			stock = { "Rumbling Terahorn" }
		},
		{
			id = "beast_folk", name = "Beast Folk Shard", position = { x = 3, y = 7 },
			stock = { "Golden Wing Striker", "Mighty Shouter", "Burning Mane", "Ultimate Force" }
		},
		{
			id = "tree_folk", name = "Tree Folk Shard", position = { x = 12, y = 7 },
			stock = { "Coiling Vines", "Thorny Mandra", "Poisonous Dahlia", "Essence Elf" }
		},
		{
			id = "fish", name = "Fish Shard", position = { x = 6, y = 8 },
			stock = { "Saucer-Head Shark", "Seamine", "Illusionary Merfolk", "Phantom Fish", "Scissor Eye" }
		},
		{
			id = "cyber_lord", name = "Cyber Lord Shard", position = { x = 10, y = 8 },
			stock = { "Corile", "Hypersquid Walter", "Teleportation" }
		},
		{
			id = "cyber_virus", name = "Cyber Virus Shard", position = { x = 16, y = 8 },
			stock = { "Candy Drop", "Faerie Child", "Spiral Gate" }
		},
		{
			id = "liquid_people", name = "Liquid People Shard", position = { x = 7, y = 10 },
